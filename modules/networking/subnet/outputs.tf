...
output "subnet_ids_list_map" {
  value = tomap({
    ...
    "database"    = [for subnet in aws_subnet.private : subnet.id if subnet.tags.Name == "private-subnet-app-1a" || subnet.tags.Name == "private-subnet-app-1b"],
    ...
    "k8s-master"  = [for subnet in aws_subnet.private : subnet.id if subnet.tags.Name == "private-subnet-k8s-master-1a" || subnet.tags.Name == "private-subnet-k8s-master-1b"],
