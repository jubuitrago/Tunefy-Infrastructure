...
cd /home/ubuntu
pwd
wget https://packages.chef.io/files/stable/chef-server/14.11.21/ubuntu/18.04/chef-server-core_14.11.21-1_amd64.deb > /dev/null 2>&1
sudo apt install ./chef-server-core_14.11.21-1_amd64.deb > /dev/null 2>&1
